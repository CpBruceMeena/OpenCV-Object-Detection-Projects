...
lower_blue = np.array([182, 193, 255])
upper_blue = np.array([192, 203, 255])
...
while True:
    ...
    if len(contours)>0:
        ...
        #Allow only contours that have a larger than 15 pixels radius
        if radius > 25:
